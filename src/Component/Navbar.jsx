...
const Navbar = () => {
  return (
    <div>
     <header className="py-lg-4 py-4 px-0 border-bottom border-bottom-lg-0 ">
    <div className="container-fluid">
        <div className="row w-100 align-items-center g-0 gx-lg-3">
            ...
            <div className="col-xxl-3 col-lg-4 d-flex align-items-center ">
                ...
                <button type="button" className="btn btn-outline-success text-reset d-none d-lg-block" data-bs-toggle="modal" data-bs-target="#locationModal">
           <i className="feather-icon icon-map-pin me-2"></i>Pick Location
                ...
                <div className="list-inline ms-auto d-lg-block d-none">
                   <div className="list-inline-item me-4">
                    ...
                    <Link to="/ShopCart" className="text-reset position-relative">
...
<nav className="navbar navbar-expand-lg navbar-dark  py-0 py-lg-2 navbar-default" style={{backgroundColor: "#23A323"}}>
      <div className="container-fluid">
      <div className="offcanvas offcanvas-start" tabindex="-1" id="navbar-default" aria-labelledby="navbar-defaultLabel">
          <div className="offcanvas-header pb-1">
          <a href="./index.html">
        <img src="../assets/images/logo/freshcart-logo.svg" alt="eCommerce HTML Template"/></a>
         ...
         <div className="offcanvas-body">
            ...
            <form action="#">
              ...
              <a className="btn btn-primary w-100 d-flex justify-content-center align-items-center " data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                <span className="me-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid">
              ...
              <div className="dropdown ml-5 me-3 d-none d-lg-block ">
              <button style={{background: "#23A323"}} className="btn  px-6 show all-department text-white" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="true">
              ...
              <ul className="dropdown-menu show" aria-labelledby="dropdownMenuButton1" data-bs-popper="static">
                <li><a className="dropdown-item" href="../pages/shop-grid.html">Dairy, Bread &amp; Eggs</a></li>
                <li><a className="dropdown-item" href="../pages/shop-grid.html">Snacks &amp; Munchies</a></li>
                <li><a className="dropdown-item" href="../pages/shop-grid.html">Fruits &amp; Vegetables</a></li>
                <li><a className="dropdown-item" href="../pages/shop-grid.html">Cold Drinks &amp; Juices</a></li>
            ...
            <ul className="navbar-nav align-items-center navbar-offcanvas-color">
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu jjj">
                    ...
                    <li><a className="dropdown-item" href="../pages/index-5.html">Home 5 <span class="badge bg-light-info text-dark-info ms-1">New</span></a></li>
                  </ul>
                </li>
                <li className="nav-item dropdown">
                  <a className="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
  ...
  {/* <div className="modal fade" id="userModal" tabindex="-1" aria-labelledby="userModalLabel" style="display: none;" aria-hidden="true">
        ...
        <div className="modal-body">
           <form>
              ...
              <div className="mb-5">
                 ...
                 <small className="form-text">By Signup, you agree to our <a href="#!">Terms of Service</a> &amp; <a href="#!">Privacy Policy</a></small>
              </div>
